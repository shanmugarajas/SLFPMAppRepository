...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#0066cc">
    <td width="15" nowrap="nowrap">&nbsp;</td>
    <td height="36" colspan="2" id="navigation" nowrap="nowrap" class="navText"><a href="viewTheHome.do">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;">PROJECTS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:;">INVOICES</a>&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp; <a href="javascript:;">REQUESTS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="viewAllResources.do">REPORTS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;">FEEDBACK</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#ffffff">
          ...
          <c:if test="${! empty SEARCH_RESOURCES_RESULTS_KEY}">
            <c:forEach var="resource" items="${SEARCH_RESOURCES_RESULTS_KEY}">
              <tr>
                ...
                <td><c:out value="${resource.empid}"></c:out>
                </td>
